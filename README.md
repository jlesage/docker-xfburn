...
This project implements a Docker container for [Xfburn](https://docs.xfce.org/apps/xfburn/start).
...
`xfburn.domain.tld` to the container at `127.0.0.1:5800`.
...
`server.domain.tld/xfburn` to the container at `127.0.0.1:5800`.
